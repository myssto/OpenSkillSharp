...
public class ThurstoneMostellerPartTests
{
    private readonly ModelTestData _testData = ModelTestData.FromJson("thurstonemostellerpart");
    private ThurstoneMostellerPart TestModel => new() { Mu = _testData.Model.Mu, Sigma = _testData.Model.Sigma };
    ...
    public void Rate_Margins()
    {
        ...
        ThurstoneMostellerPart marginTestModel = new()
        {
    ...
    public void Rate_LimitSigma()
    {
        ...
        ThurstoneMostellerPart limitSigmaTestModel = new()
        {
    ...
    public void Rate_Balance()
    {
        ...
        ThurstoneMostellerPart balanceModel = new()
        {
    ...
    {
        // Arrange
        ThurstoneMostellerPart windowTauModel = new()
        {
        ...
        Assertions.RatingsEqual(playerB, results[1].Players.ElementAt(0));
    }
}
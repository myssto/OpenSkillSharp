...
{
    private readonly ModelTestData _testData = ModelTestData.FromJson("bradleyterryfull");
    private BradleyTerryFull TestModel => new() { Mu = _testData.Model.Mu, Sigma = _testData.Model.Sigma };
    ...
    public void Rate_Margins()
    {
        ...
        BradleyTerryFull marginTestModel = new()
        {
    ...
    public void Rate_LimitSigma()
    {
        ...
        BradleyTerryFull limitSigmaTestModel = new()
        {
    ...
    public void Rate_Balance()
    {
        ...
        BradleyTerryFull balanceModel = new()
        {

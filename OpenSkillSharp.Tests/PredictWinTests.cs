...
public class PredictWinTests
{
    ...
    public PredictWinTests()
    {
        ...
        var b1 = _model.Rating(73.381, 1.421);
    ...
    public void PredictWin_FFA_NewPlayers(int nTeams, double expectedProbability)
    {
        ...
        var probabilities = _model.PredictWin(teams).ToList();
    ...
    {
        var probabilities = _model.PredictWin([_team1, _team2]).ToList();
    ...
    {
        var probabilities = _model.PredictWin([
            _team1,
            _team2,
